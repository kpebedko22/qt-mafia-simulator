...
public:
	...
	Role* role;					// хранит наследника Mafia/Civilian/Detective/Doctor/Courtesan

	struct Sympathy{
		Sympathy(Player* player_, int points_){ cur_player = player_; points = points_; }
		Player* cur_player;
		int points;
	};
...
private:
	Player_info info;			// хранит все статы игрока
